    ...
    */
	...
	public function index()
	{
		...
		$article = [
	        ...
	        'meta_title' => 'Car Driver is here!',
	        'meta_description' => 'Car Driver is here!',
	        'summary' => 'Car Driver is here!',
	        'body' => '<p>Car Driver is here!</p>',
		...
		if ($this->cache->has($key)) {
			...
			$vars = [
				'page_title'		=> 'Car Driver Blog',
				'request'			=> $this->request,
				'articles'			=> $articles,
			];
			$view = view('blog', compact('vars'))->render();
	...
	public function article($slug = '')
	{
		...
		if ($this->cache->has($key)) {
			...
			$view = view('blog-post', compact('vars'))->render();
			$this->cache->add($key, $view, env('APP_CACHE_MINUTES'));
		}
		return $view;
	}
